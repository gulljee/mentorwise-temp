        ...
        <div className="min-h-screen bg-black flex">
            ...
            <div className="w-64 bg-[#0a0a0a] border-r border-gray-800 flex flex-col">
                ...
                <nav className="flex-1 p-4">
                    ...
                    {/* Profile and Settings buttons removed here */}
                        ...
                        <div>
                            {loadingStudents ? (
                                ...
                                <div className="bg-[#1a1a1a] rounded-xl p-12 text-center border border-gray-800">
                                    ...
                                    <h3 className="text-xl font-semibold text-white mb-2">No Active Students</h3>
                                    <p className="text-gray-400">You haven't accepted any mentorship requests yet.</p>
                                </div>
                            ) : (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {students.map((connection) => (
                                        <div key={connection._id} className="bg-[#1a1a1a] rounded-xl p-6 border border-gray-800 hover:border-blue-600/50 transition-all group">
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-sm text-gray-400 mb-2">
                                                        {connection.mentee.department} • Batch {connection.mentee.batch}
                                                    </p>
